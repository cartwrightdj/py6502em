...
; multiple of $2000.
        ...
        .org    $E000
        .export START, rdkey
		.export Z1d, ch, var, lomem, himem, rnd, noun_stk_l, syn_stk_h, noun_stk_h_str, syn_stk_l, noun_stk_h_int, txtndxstk, text_index, leadbl, pp, pv, acc, srch, tokndxstk, srch2, if_flag, cr_flag, current_verb, precedence
		.export x_save, run_flag, aux, pline, pverb, p1, p2, p3, token_index, pcon, auto_inc, auto_ln, auto_flag, char, leadzr, for_nest_count, gosub_nest_count, synstkdx, synpag
		.export gstk_pverbl, gstk_pverbh, gstk_plinel, gstk_plineh
		.export fstk_varl, fstk_varh, fstk_stepl, fstk_steph, fstk_plinel, fstk_plineh, fstk_pverbl, fstk_pverbh, fstk_tol, fstk_toh
		.export buffer, KBD, KBDCR, DSP, rdkey
		.export Se00c, Se011, Se018, nextbyte, Le034, list_comman, list_all, list_cmd, list_line, list_int, list_token
		.export paren_substr, comma_substr, Se118, str_arr_dest, dim_str, input_str, string_lit, Se1bc, string_eq, string_neq
		.export mult_op, Se254, Se25b, mod_op, read_line, cold, warm, Le2b6, Le2f9, Le2fb, Le883
...
Le2b6:  LSR     run_flag
        LDA     #'>'        ; Prompt character (high bit set)
        JSR     cout
        LDY     #$00
        STY     leadzr
        BIT     auto_flag
